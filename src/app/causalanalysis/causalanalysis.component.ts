  ...
  ngOnInit(): void {
    ...
    const nodes: any[] = [
      ...
      
      {
        ...
        label: "Central Mediterranean Route",
        x: -550,
        y: -600,
      },
      {
        ...
        font: { multi: true },
        widthConstraint: { minimum: 120 },
        label: "Western Mediterranean Route",
        x: -550,
        y: -500,
      },
      {
...

      {
        ...
        label: "Total Irregular Migrants in Europe Via Nothern African Routes \n\n\n Text",
        x: -100,
        y: -500,
      },

      {
        ...
        font: { multi: true },
        widthConstraint: { minimum: 400 },
        label: "Total Irregular Migrants in UK from Nothern African Routes \n\n\n Text",
        x: -10,
        y: -680,
      },
